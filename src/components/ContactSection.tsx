...
export default function ContactSection() {
  ...
  // Paleta derivada (sólida y con alto contraste en dark)
  const t =
    theme === "dark"
      ? {
  ...
  // mailto fallback (sin backend)
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    const fd = new FormData(e.currentTarget) as unknown as any;
    ...
    // Cambia este correo si lo deseas
    const mailto = `mailto:santiagoo.rugeeb@gmail.com?subject=${subject}&body=${body}`;

    // Abrimos mailto y marcamos como enviado “ok”
  ...
  return (
    <section
      ...
      style={{ scrollMarginTop: 96 }} // para navbar flotante
    >
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          {ok === "ok" && (
            ...
            >
              Gracias por tu mensaje. Se abrió tu cliente de correo para
              enviarlo ✉️
            </div>
          )}
        </motion.div>
