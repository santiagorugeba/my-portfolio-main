  ...
  return (
    ...
    >
      ...
      <div className="p-5 md:p-6">
        <h3 className="text-xl font-extrabold text-brand-light mb-1 break-words">
          {title}
        </h3>

        {subtitle ? (
          <p className="text-brand-light/70 text-sm mb-3">{subtitle}</p>
        ) : null}
        ...
        {bullets.length > 0 ? (
          <ul className="space-y-2 mb-5 text-brand-light/80 text-sm">
