/**
 * Constante `about` para la sección "Acerca de mí".
 * Contiene información estructurada para una fácil visualización y mantenimiento.
 */
export const about = {
  ...
  paragraphs: [
    'Soy Santiago, ingeniero multimedia que hace 3 años decidí dedicarme completamente al UX/UI. Me di cuenta de que mi pasión no estaba solo en la tecnología, sino en entender cómo las personas interactúan con ella. He diseñado para sectores como gaming, capital humano, energía y retail, siempre con una misión clara: crear productos que conecten con las personas y hagan crecer los negocios. Como cristiano, amo la música que alaba a Dios y siento una conexión especial con Él cuando diseño, porque reconozco que fue Él quien diseñó cada parte de este universo.',
    ...
    'Para mí, el diseño no es solo estética o funcionalidad. Es la herramienta que conecta a las personas con la tecnología de manera natural e intuitiva. Cada proyecto es una oportunidad de contar una historia, de crear algo que realmente importe y que marque la diferencia en la vida de las personas. Más abajo comparto contigo algunas promesas bíblicas que han sido luz en mi camino, y mi deseo es que encuentren un lugar especial en tu vida también.',
  ],
