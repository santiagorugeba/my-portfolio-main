export const cases = [
  {
    ...
    bullets: [
      ...
      "Perfiles segmentados de usuarios",
      "Insights convertidos en acciones"
    ],
    cards: [
      {
        icon: "/pen-tool.svg",
        title: "Investigación UX",
        description: "Entrevistas cualitativas y cuantitativas con pequeños comerciantes para entender sus necesidades y comportamientos en pagos QR."
      },
      {
        icon: "/pen-tool.svg",
